...
<body>
    ...
    <section id="rekomendasi">
        <div class="container">
            <?php
            $sql = "SELECT * FROM rumah_sewa ORDER BY created_at DESC";
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo '
                    <div class="card">
                        <a href="tambah_sewa_rumah.php" class="add-button">+</a>
                        <img src="uploads/' . htmlspecialchars($row['gambar']) . '" alt="' . htmlspecialchars($row['nama_rumah']) . '">
                        <div class="card-content">
                            <h3 class="price">IDR ' . number_format($row['harga'], 0, ',', '.') . ' /Year</h3>
    ...
    <a href="tambah_sewa_rumah.php" class="add-button-fixed">+</a>
