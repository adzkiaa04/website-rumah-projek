...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($gambar_tmp, $gambar_path)) {
            ...
            $sql = "INSERT INTO beli_rumah (nama_rumah, harga, nomor_kontak, alamat, kamar_tidur, kamar_mandi, luas_rumah, gambar) 
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("ssssssss", $nama_rumah, $harga, $nomor_kontak, $alamat, $kamar_tidur, $kamar_mandi, $luas_rumah, $gambar_name);
                ...
                $alert = "<script>
                            document.addEventListener('DOMContentLoaded', function() {
                                Swal.fire({
                                    ...
                                    window.location='beli_rumah.php';
                                });
                            });
                        </script>";
            } else {
...
<body>
    <div class="form-container">
        <h2>Tambah Rumah</h2>
        <form action="tambah_beli_rumah.php" method="POST" enctype="multipart/form-data">
        ...
        <a href="beli_rumah.php" class="back-link">Kembali</a>
    </div>
