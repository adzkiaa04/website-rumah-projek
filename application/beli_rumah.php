...
<body>
        ...
        <div class="container h-100">
            <div class="row h-100">
                <div class="col-md-6 hero-tagline my-auto">
                    <h1>CARI REKOMENDASI TIPE RUMAH UNTUKMU</h1>
                    <p>
    ...
    <section id="rekomendasi">
        <div class="container">
            <?php
            $sql = "SELECT * FROM beli_rumah ORDER BY created_at DESC";
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo '
                    <div class="card">
                        <a href="tambah_beli_rumah.php" class="add-button">+</a>
    ...
    <a href="tambah_beli_rumah.php" class="add-button-fixed">+</a>
